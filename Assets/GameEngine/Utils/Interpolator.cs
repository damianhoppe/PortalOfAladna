...
public partial class Interpolator<T>
{
    ...
    public Interpolator(T startingValue, T targetValue, float fullTime, ICalculatorInterpolation<T> calculatorInterpolation, IOnUpdateInterpolation<T> onUpdateListener)/* : base(fullTime, calculatorInterpolation, onUpdateListener)*/
    {
