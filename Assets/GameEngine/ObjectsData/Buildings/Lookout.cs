...
public class Lookout : DefaultBuilding
{
    ...
    */
    ...
    {
        ObjectName = "Lookout";
        ObjectDescription = "This is a lookout, with high view range.";
        ObjectType = "Building";
        ObjectTypeID = 1;
        ObjectSubtype = "Default Lookout";
        ObjectSubtypeID = 2;
        ...
        PositionValue = 1.0f;
        PositionObstacle = 1.0f;
        PositionDanger = 2.5f;
        
        BaseCost = new DataStructures.Cost(50.0f, 15.0f, 5.0f, 0.0f, 0.0f, 0.0f);
        EnergyToBuild = 10.0f;
        RequiredHumans = 5;
