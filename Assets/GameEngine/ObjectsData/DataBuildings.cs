...
public class DataBuildings : MonoBehaviour
{
    ...
    public class DefaultBuilding : DataSpecialObjects.DefaultObject
    {
        public new string ObjectName { get; protected set; } = "Default Building";
        public new string ObjectDescription { get; protected set; } = "Default Building Description";
        public new string ObjectType { get; protected set; } = "Building";
        public new int ObjectTypeID { get; protected set; } = 1;
