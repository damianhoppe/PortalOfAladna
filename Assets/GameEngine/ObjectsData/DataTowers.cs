...
public class DataTowers : MonoBehaviour
{
    ...
    public class DefaultTower : DataSpecialObjects.DefaultObject
    {
        public new string ObjectName { get; protected set; } = "Default Tower";
        public new string ObjectDescription { get; protected set; } = "Default Tower Description";
        public new string ObjectType { get; protected set; } = "Tower";
        public new int ObjectTypeID { get; protected set; } = 2;
