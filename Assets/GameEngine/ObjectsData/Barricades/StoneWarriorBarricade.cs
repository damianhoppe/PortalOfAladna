...
public class StoneWarriorBarricade : StoneBarricade
{
    ...
    protected override void Start()
    {
        ...
        this.ObjectName = "Stone Warrior Barricade";
        this.ObjectDescription = "This is a stone warrior barricade, with increased attack.";
        this.ObjectType = "Tower";
        this.ObjectTypeID = 1;
        this.ObjectSubtype = "Default Stone Warrior Barricade";
